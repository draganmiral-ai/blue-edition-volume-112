...
The HTML, CSS, and JavaScript in this repository (everything outside of
`assets/images/`) is © Dragan Andric. It is shared publicly so the project can
be built and deployed transparently, but no license is granted for reuse,
redistribution, or derivative works. If you would like to reuse the code,
please contact the rights holder for permission.

## Photographs and visual artworks

All photographs and visual artworks in `assets/images/` (including originals
and derived web/optimized versions) remain the property of Dragan Andric and
